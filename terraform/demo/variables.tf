...
variable "asg_desired_capacity" {
  ...
  type        = number
  default     = 0 # Disabled for demo - using static workers
}
...
variable "domain_name" {
  description = "Domain name for demo (e.g., kubestock-demo.dpiyumal.me)"
  type        = string
  default     = "kubestock-demo.dpiyumal.me"
}
