#!/bin/bash
# ==================================================
# KubeStock SSH Tunnel to Alertmanager UI (via NLB)
# ==================================================
# Access Alertmanager web UI to view/manage/silence alerts
# Note: Alertmanager is only enabled in production environment
